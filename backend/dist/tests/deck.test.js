...
const deck_1 = require("../src/uno-game-engine/deck");
describe('getShuffledCardDeck', () => {
    test('should return an array of 108 cards', () => {
        const deck = (0, deck_1.getShuffledCardDeck)();
        ...
        }
        {
            ...
            const reverseCards = deck.filter((card) => card.value === 'reverse');
...
describe('testing deck.ts', () => {
    test('makeCard', () => {
        const card = (0, deck_1.makeCard)('number', 'blue', '3');
...
describe('shuffle function', () => {
    test('should change order of elements', () => {
        // Create a mock deck
        const deck = [
            (0, deck_1.makeCard)('number', 'red', '1'),
            (0, deck_1.makeCard)('number', 'blue', '2'),
            (0, deck_1.makeCard)('number', 'red', '1'),
            (0, deck_1.makeCard)('number', 'yellow', '1'),
        ];
        // Create a copy of the deck for comparison
        const originalDeck = [...deck];
        (0, deck_1.shuffle)(deck);
        // Check that the order of elements has changed
        const orderChanged = deck.some((card, index) => card !== originalDeck[index]);
